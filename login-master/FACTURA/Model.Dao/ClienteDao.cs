...
{    
    public class ClienteDao : Obligatorio<Cliente>
    {
        ...
        {
            string create = "insert into cliente(nombre,apPaterno,apMaterno,dni,direccion,telefono) values('" + objCliente.Nombre + "','" + objCliente.Appaterno + "','" + objCliente.Apmaterno + "','" + objCliente.Cedula + "','" + objCliente.Direccion + "','" + objCliente.Telefono + "')";
            try
            {
        ...
        {
            string create = "sp_cliente_adc " + objCliente.IdCliente + "," + objCliente.Nombre + "," + objCliente.Appaterno + "," + objCliente.Apmaterno + "," + objCliente.Cedula + "," + objCliente.Direccion + "," + objCliente.Telefono + "";
            try
            {
                comando = new SqlCommand(create, objConexinDB.getCon());
                objConexinDB.getCon().Open();
        ...
        public bool find(Cliente objCliente)
        {
            ...
            try
            {
                ...
                if (hayRegistros)
                {
                    ...
                    objCliente.Cedula = reader[6].ToString();
        ...
        {
            string update = "update cliente set nombre='" + objCliente.Nombre + "',apPaterno='" + objCliente.Appaterno + "',apMaterno='" + objCliente.Apmaterno + "',dni='" + objCliente.Cedula + "',direccion='" + objCliente.Direccion + "',telefono='" + objCliente.Telefono + "' where idCliente='" + objCliente.IdCliente + "'";
            try
            {
        ...
        {
            bool hayRegistros;
            string find = "select*from cliente where dni='"+objCliente.Cedula+"'" ;
            try
            {
                comando = new SqlCommand(find, objConexinDB.getCon());
                objConexinDB.getCon().Open();
        ...
        public List<Cliente> findAllCliente(Cliente objCLiente)
        {
            ...
            string findAll = "select* from cliente where nombre like '%" + objCLiente.Nombre + "%' or dni like '%" + objCLiente.Cedula + "%' or idCliente like '%" + objCLiente.IdCliente + "%' or apPaterno like '%" + objCLiente.Appaterno + "%'";
            try
            {
                comando = new SqlCommand(findAll, objConexinDB.getCon());
                objConexinDB.getCon().Open();
