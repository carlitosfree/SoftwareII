            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                      <a href="http://google.com" target="_blank" class="">Mas informacion</a>
                  </li>
                  <!-- Menu Footer-->
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./?view=provider">Proveedores</a></li>
              </ul>
            </li>
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2017 <a href="#" target="_blank">Enlace</a></strong>
      </footer>-->
