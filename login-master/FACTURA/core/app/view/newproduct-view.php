...
<div class="row">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="barcode" id="product_code" class="form-control" id="barcode" placeholder="Codigo Producto">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="unit"  class="form-control" id="unit" placeholder="Cantidad del Producto">
    </div>
  </div>
