...
<div class="col-md-12">
<p><b>Buscar Cliente por nombre o cedula:</b></p>
	<form id="searchpe">
	<div class="row">
		<div class="col-md-6">
			<input type="hidden" name="view" value="sell">
			<input type="text" id="person_id" name="person" class="form-control">
		</div>
		<div class="col-md-3">
		<button type="submit" class="btn btn-primary"><i class="glyphicon glyphicon-search"></i> Buscar</button>
		</div>
	...
	<div id="show_search_results2"></div>
</div>

<script>
//jQuery.noConflict();
$(document).ready(function(){
	$("#searchpe").on("submit",function(e){
		e.preventDefault();

		$.get("./?action=searchclient",$("#searchpe").serialize(),function(data){
			$("#show_search_results2").html(data);
		});
		$("#person_code").val("");
	});
});
...
$(document).ready(function(){
		$("#person_code").keydown(function(e){
				if(e.which==17 || e.which==74){
						e.preventDefault();
				}else{
						console.log(e.which);
...
<div class="form-group">
    ...
    <div class="col-lg-10">
    <?php
		$clients1 = PersonData::getClients();
    ?>
    ...
    <div class="col-lg-10">
			<input type="text" name="name" class="form-control" id="name" value="<?php echo $client->name." ".$client->lastname;?>">
    </div>
	</div>
<?php endif; ?>
				...
				<div class="col-md-6 col-md-offset-6">
					<div class="box box-primary">
						<table class="table table-bordered">
							<tr>
	<td><p>Subtotal</p></td>
	<td><p><b>$ <?php echo number_format($total*.88); ?></b></p></td>
</tr>
<tr>
	<td><p>IVA</p></td>
	<td><p><b>$ <?php echo number_format($total*.12); ?></b></p></td>
</tr>
<tr>
	<td><p>Total</p></td>
